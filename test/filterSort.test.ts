...
const rows: OfficialListRow[] = [
  { id: '1', slug: '1', name: '陳一', party: '國民黨', officeType: 'legislator', district: '北市3', judgmentCount: 2, controversyCount: 1, latestAssetTotal: 120000000 },
  { id: '2', slug: '2', name: '林二', party: '民進黨', officeType: 'legislator', district: '不分區', judgmentCount: 0, controversyCount: 0, latestAssetTotal: 24000000 },
  { id: '3', slug: '3', name: '王三', party: '民眾黨', officeType: 'mayor_magistrate', district: '台中', judgmentCount: 1, controversyCount: 3, latestAssetTotal: null },
];
